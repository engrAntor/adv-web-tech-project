...
export class CoursesController {
  ...
  async create(
    ...
    return this.coursesService.createCourse({
      ...body,
      instructorId: req.user.role === UserRole.INSTRUCTOR ? req.user.id : undefined,
    });
  }
  ...
  @Post(':id/enroll')
  @UseGuards(JwtAuthGuard)
  async enroll(@Param('id') id: number, @Request() req: any): Promise<Progress> {
  ...
  async updateProgress(
    ...
    return this.coursesService.updateProgress(req.user.id, +id, body.completionPercentage);
  }
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles(UserRole.ADMIN, UserRole.INSTRUCTOR)
  async createCourse(@Body() body: { title: string; description: string }): Promise<Course> {
