...
export class ContactController {
  ...
  async create(
    ...
    return this.contactService.create(body.name, body.email, body.subject, body.message, userId);
  }
  ...
  async updateStatus(
    ...
    return this.contactService.updateStatus(+id, body.status, body.adminResponse);
  }
