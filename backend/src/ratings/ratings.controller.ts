...
export class RatingsController {
  ...
  async create(
    ...
    return this.ratingsService.create(req.user.id, body.courseId, body.rating, body.review);
  }
  ...
  @UseGuards(JwtAuthGuard)
  async getUserCourseRating(@Request() req: any, @Param('courseId') courseId: number) {
  ...
  async moderate(@Param('id') id: number, @Body() body: { isApproved: boolean }) {
