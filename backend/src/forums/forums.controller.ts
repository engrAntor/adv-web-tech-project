...
export class ForumsController {
  ...
  async createForum(@Body() body: { name: string; description?: string; courseId?: number }) {
    return this.forumsService.createForum(body.name, body.description, body.courseId);
  }
  ...
  async createPost(
    ...
    return this.forumsService.createPost(+forumId, req.user.id, body.title, body.content, body.tags);
  }
